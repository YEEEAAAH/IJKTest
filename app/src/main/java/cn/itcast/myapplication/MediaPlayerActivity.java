...
//        path = getExternalFilesDir(null)+"test.mp4";
        Log.d(TAG, "initPlayer: "+path);
    ...
    private void initViewListener() {
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                //if the progress change was initiated by the user.
                if (fromUser) {
...
/*        Log.d(TAG, "onClick: "+"player been clicked");
        if(player!=null){
            if(player.isPlaying()){
                player.pause();
            }else{
    ...
    static class WeakHandler extends Handler {
        ...
        public WeakHandler(MediaPlayerActivity activity) {
            weakReference = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final MediaPlayerActivity activity = weakReference.get();
            switch (msg.what) {
                case 888:
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        Log.e(TAG, "onConfigurationChanged: "+" In" );
        ...
        if(portrait){
            Log.d(TAG, "onConfigurationChanged: "+"ic_fullscreen");
            tvScale.setBackgroundResource(R.drawable.ic_fullscreen);
        }
        else {
            Log.d(TAG, "onConfigurationChanged: "+"ic_fullscreen_exit");
            tvScale.setBackgroundResource(R.drawable.ic_fullscreen_exit);
        }
